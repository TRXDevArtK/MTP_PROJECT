...
<html>
    ...
    <body>
        <div class="container">  
            ...
            <br />
            <div align="left">
                <a href="mtk_skp_add.php"><input type="button" class="btn btn-info" value="Tambah Matkul" /></a>
            </div>
        ...
        $.ajax({
            ...
            {   
                ...
                for(count; count < data.length; count++){
                    ...
                    html += '<td>\n\
                                <i></i><form action="mtk_skp_data.php" method="post" class="pull-left">\n\
                                ...
                                <i></i><input type="button" class="pull-left btn btn-danger" id="mtk_skp_del" id_s="'+data[count].id+'"value="Hapus Matkul" style="margin-right:10px">\n\
                                <i></i><form action="mtk_skp_edit.php" method="post" class="pull-left">\n\
                                            <input type="hidden" name="id" value="'+data[count].id+'" readonly>\n\
